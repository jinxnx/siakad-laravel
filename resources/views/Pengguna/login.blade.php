...
<body>
  ...
  <style type="text/css">
      ...
      <form action="{{ route('postlogin') }}" method="POST"> 
        {{ csrf_field() }}
        <h4>SIAKAD - <span>SMK Negeri 1 Sijunjung</span></h4>
        <p>Silahkan Login</p>
  ...
  <style type="text/css">
      ...
      .st1{fill:#010101;}
        ...
        <br>
        <p style="font-family: sans-serif; margin: auto;"> Belum Punya Akun ? <a href="" style="text-decoration: none; color: #5a5a5a; font-family: San Serif"> Daftar </a></p>
      </form>
    </div>
  </body>
