...
<br/>
<h1 class="card-title" style="text-align:center; font-size:2rem"> Biodata Staff Sekolah </h1>
<div class="box1" style="width:150px; height:200px; margin:2rem 0rem 0rem 10rem">
<?php  
$a = $tampilan_staff->id_staff;
...
<div class="box2" style="margin:-12.5rem 0rem 2rem 21rem; width:35rem; height:auto">
...
<table border="1" cellpadding="5" style="border-color:white">
    <tr>
      ...
      <td> : </td>
      <td style="width:20rem">{{ $tampilan_staff->nama }}</td>
    </tr>
    <tr>
      <td> NIP </td>
      <td> : </td>
      <td> {{ $tampilan_staff->nip }} </td>
    </tr>

    <tr>
      <td> Bidang </td>
      <td> : </td>
      <td> {{ $tampilan_staff->bidang }} </td> 
    </tr>

  <tr>    
    <td> NUPTK </td>
    <td> : </td>
    <td> {{ $tampilan_staff->nuptk }} </td>
  </tr>
    ...
    <tr>  
      ...
      <td> 
      <?php 
      $jk=($tampilan_staff->jenis_kelamin); 
      if ( $jk == "L") {
        echo "Laki-laki";
      } else {
        echo "Perempuan";
    ...
    <tr>  
      <td> Jabatan </td>
      <td> : </td>
      <td> {{ $tampilan_staff->jabatan}} </td>
    </tr>
    
    <tr>  
      <td> Tempat Lahir </td>
      <td> : </td>
      <td> {{ $tampilan_staff->tempat_lahir }}</td>
    </tr>
    
    <tr>  
      <td> Tanggal Lahir </td>
      <td> : </td>
      <td> {{ $tampilan_staff->tanggal_lahir }} </td>
    </tr>
    
    <tr>  
      <td> Nama Ibu </td>
      <td> : </td>
      <td> {{ $tampilan_staff->nama_ibu}} </td>
    </tr>
  </table>
		</div>
		</div>
...
<table border="1" cellpadding="5" style="border-color:white">
    ...
    <tr>  
      ...
      <td> : </td>
      <td style="width:20rem"> {{ $tampilan_staff->golongan_capeg }} </td>
    </tr>
    
    <tr>  
      <td> Terhitung Mulai Tanggal </td>
      <td> : </td>
      <td> {{ $tampilan_staff->tmt_capeg }} </td>
    </tr>
</table>
		</div>
		</div>
...
<table border="1" cellpadding="5" style="border-color:white">
    ...
    <tr>  
      <td style="width:14rem"> Golongan </td>
      <td> : </td>
      <td style="width:20rem"> {{ $tampilan_staff->golongan_akhir }} </td>
    </tr>
    
    <tr>  
      <td> Terhitung Mulai Tanggal </td>
      <td> : </td>
      <td> {{ $tampilan_staff->tmt_akhir }}  </td>
    </tr>

    <tr>  
      <td> Masa Kerja  </td>
      <td> : </td>
      <td> {{ $tampilan_staff->masa_kerjath }} Tahun {{ $tampilan_staff->masa_kerjabln }} Bulan  </td>
    </tr>

    <tr>  
      <td> Mulai Bertugas di Sekolah Ini </td>
      <td> : </td>
      <td> {{ $tampilan_staff->mulai_tugas }}  </td>
    </tr>
  </table>
  </div>
  </div>
...
<table border="1" cellpadding="5" style="border-color:white">
    <tr>  
      ...
      <td> : </td>
      <td style="width:20rem"> {{ $tampilan_staff->tingkat_ijazah}} </td>
    </tr>
    
    <tr>  
      <td> Jurusan Perkuliahan </td>
      <td> : </td>
      <td> {{ $tampilan_staff->jurusan_kuliah }} </td>
    </tr>
    
    <tr>  
      <td> Tahun Tamat </td>
      <td> : </td>
      <td> {{ $tampilan_staff->tahun_tamat }} </td>
    </tr>
  </table>
      </div></div></div>
...
<table border="1" cellpadding="5" style="border-color:white">
    ...
    <tr>  
      ...
      <td> : </td>
      <td style="width:20rem"> {{ $tampilan_staff->keterangan }}  </td>
    </tr>
